    ...
    def config_env(self) -> Env:
        ...
        if len(dataset.episodes) == 0:
            ...
            raise ValueError(
                ...
                "(e.g. EU6Fwq7SyZv is in val_unseen, not val_seen)."
            )
        ...
        for scene in sorted(scene_episode_dict.keys()):
            ...
            for episode in episodes[idx::self.env_num]:
                ...
                while not env.episode_over:
                    ...
                    vggt_times_ms.append(getattr(self.model.model, "last_vggt_ms", 0.0))
                    ...
                    ep_peak_vggt_kv = max(
                        ep_peak_vggt_kv,
                        vggt_kv_bytes(self.model.model.past_key_values_vggt) / 1024 ** 2,
                    )
                    if torch.cuda.is_available():
...
class JanusVLN_Inference:
    ...
    def call_model(
        ...
        del inputs, cont, images_vggt, image_inputs
        return answers
